...
import microtech.hxswork.com.latte.R2;
import microtech.hxswork.com.latte.middle.BaseFragment;
...
public  abstract  class BaseBottomFragment extends MiddleFragment implements View.OnClickListener {
    ...
    LinearLayoutCompat mBottomBarLinear;
    @Override
    ...
    public void onBindView(@Nullable Bundle savedInstanceState, View rootView) {
        ...
        loadMultipleRootFragment(R.id.bottom_fragment_continuer,mIndexFragment,fragmentArray);
