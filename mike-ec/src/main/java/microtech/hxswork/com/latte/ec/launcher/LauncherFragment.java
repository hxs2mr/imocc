...
public class LauncherFragment extends MiddleFragment {//app启动界面 左右轮播图
    ...
    Button luncher_startbutton=null;//=bind(R.id.luncher_startbutton);
    ViewPager viewPager =null;//= bind(R.id.pager);
    LinearLayout linearLayout=null;//= bind(R.id.luncher_linear);

    ImageView luncher_backimage=null;//= bind(R.id.luncher_backimage);
